            ...
            <div className="footer-cont">
               <div className="ft-info">
                  ...
                  <div className="ft-info-p2">
                    <div className="form1">{formerror}</div>
               ...
               <div className="ft-list">
                  ...
                  <div className="ft-list" id="contact">
                     ...
                     <ul className="ft-list-items">
                         <li>
                          <a href="khushik7698@gmail.com">support@healthplus.com</a>
                         </li>
                         <li>
                          <a href="khushik7698@gmail.com">
                            appointment@helathplus.com
                          </a>
                         </li>
                         <li>
                         ...
                         <li>
                          <a href="tel:+022 5454 5252">+022 2326 6328</a>
                         </li>
                     </ul>
                  </div>
            </div>
